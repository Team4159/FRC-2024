...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        autoSpk.and(kinesthetics::shooterHasNote).and(() -> SpeakerLTEquation.isInRange(kinesthetics))
            .onTrue(s_Neck.new ChangeState(SpinState.ST))
            .whileTrue(new SpeakerLTEquation(kinesthetics, s_Swerve, s_Shooter, () -> -driver.getY() / 3, () -> -driver.getX() / 3))
